...
//            let alert : UIAlertController = UIAlertController.init(title: "", message: "Please create a to-do list first", preferredStyle: .alert)
//            let actionsure : UIAlertAction = UIAlertAction.init(title: "OK", style: .default) { (actionsure) in
                return
//            }
		}
    ...
    @IBAction func HomeGetWeather(_ sender: Any) {
        ...
        {
            let WeatherGit = WeatherMyCityViewController.init()
...
extension TaskTableViewController : CLLocationManagerDelegate
{
